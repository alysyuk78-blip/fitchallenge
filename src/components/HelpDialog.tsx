        ...
        <ScrollArea className="max-h-[70vh] pr-4">
          <div className="space-y-5 pb-2">
            <Step n={1} title="Підключіть спільний доступ">
              ...
              «Спільний доступ»: один із вас <b>створює кімнату</b> і ділиться 6-літерним кодом або
              QR-кодом, решта <b>приєднуються за кодом</b>. Усі зміни синхронізуються автоматично
              кожні кілька секунд. Сервер уже працює — нічого встановлювати й запускати не потрібно,
              ані вам, ані друзям.
            </Step>
